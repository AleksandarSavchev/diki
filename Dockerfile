...
FROM alpine:3.24.1 AS diki-ops-builder

ARG TARGETARCH

RUN apk --no-cache add curl &&\
    curl -sLf https://github.com/containerd/nerdctl/releases/download/v2.3.4/nerdctl-2.3.4-linux-${TARGETARCH}.tar.gz -o /nerdctl.tar.gz &&\
